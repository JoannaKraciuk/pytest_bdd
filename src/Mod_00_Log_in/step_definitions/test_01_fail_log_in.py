...
from Mod_00_Log_in.conftest import url, error_message

@scenario("C:/Users/valcr/PycharmProjects/Saucedemo_e2e/src/Mod_00_Log_in/features/fail_log_in.feature",
    "Fail login")
...
def check_page_url(login_page: LoginPage, error_message):
    current_message = login_page.error_message
    assert current_message.inner_text() == error_message
